...
export const appShellStyles = {
  ...
  // Desktop Sidebar
  // sidebar: "hidden lg:flex flex-col h-screen bg-white/80 backdrop-blur-xl border-r border-gray-200/60 transition-all duration-500 ease-in-out relative",
  sidebar: "hidden lg:flex flex-col min-h-screen bg-white/80 backdrop-blur-xl border-r border-gray-200/60 transition-all duration-500 ease-in-out relative",
  ...
  sidebarContainer: "px-6 py-8 flex flex-col flex-1 relative z-10",
...
export const loginStyles = {
  ...
  root: "h-screen w-full bg-gradient-to-br from-gray-50 via-blue-50/30 to-indigo-50/20",
