...
// import StatusBadgeStyles from "../assets/dummyStyles";
...
const StatusBadge = ({ status = "", size = "default", showIcon = true }) => {
  ...
  const config = statusConfig[s] || StatusIcons.default;
  ...
  return (
    ...
    >
      <div
        className={`absolute inset-0 bg-linear-to-r ${config.gradient} opacity-0
