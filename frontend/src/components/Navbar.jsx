...
const Navbar = () => {
  ...
  useEffect(() => {
    if(!isSignedIn) return; // changes at ___
        ...
        <nav className={navbarStyles.nav}>
          <div className={navbarStyles.logoSection}>
            <Link to="/" className={navbarStyles.logoLink}>
              ...
              <span className={navbarStyles.logoText}>InvoCraftAI</span>
            </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            {/* <button onClick={()=> setOpen(!open)} className= {navbarStyles.mobileMenuButton}></button> */}
          </div>
        </nav>
      </div>
      <div
