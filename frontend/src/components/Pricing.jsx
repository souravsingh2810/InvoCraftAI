  ...
  >
    {isPopular && (
      <div className={pricingCardStyles.popularBadge}>
        <div className={pricingCardStyles.popularBadgeContent}>MostPopular</div>
      </div>
    )}
    ...
    <div className={pricingCardStyles.content}>
      ...
      <div className={pricingCardStyles.priceContainer}>
        ...
        {isAnnual && (
          <div className={pricingCardStyles.annualBadge}>Save 20% Anually</div>
        )}
      </div>
      ...
      <div className={pricingStyles.pricingContainer}>
        ...
        <div className={pricingStyles.additionalInfo}>
            <div className={pricingStyles.featuresCard}>
                ...
                <div className={pricingStyles.featureItem} key={index}>
